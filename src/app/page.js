  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .float-heart:nth-child(2) { left: 25%; animation-delay: 2s; }
        .float-heart:nth-child(3) { left: 50%; animation-delay: 4s; }
        .float-heart:nth-child(4) { left: 70%; animation-delay: 6s; }
        .float-heart:nth-child(5) { left: 85%; animation-delay: 8s; }
        @keyframes fadeIn {
